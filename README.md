...
- The game is implemented as both a CLI (Comamand Line Interface) and a graphical application, utilising the [JavaFX SDK](https://openjfx.io/).
...
- A [demonstration](MagicBakery_GUI_Recording.zip) of the Graphical Application can be found in the *root of this repo*. 


## Prerequisites

- [Java](https://www.java.com/en/) version >= 17
- Only for the Graphical implementation
    - [JavaFX SDK](https://gluonhq.com/products/javafx/) version >= 17
    - Displays with a resolution of **2560 x 1440** (Subject to Change)
- Knowledge of the game rules (can be found online)
...
The CLI can be run using the following command on the terminal. Please ensure that you are in the root of the directory when you run this command.
