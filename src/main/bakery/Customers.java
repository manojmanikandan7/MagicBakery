...
public class Customers implements Serializable {
     ...
     *
     * @param deckFile   the file path of the deck used to initialise the customer
     *                   deck.
     * @param random     the random object used to shuffle the customer deck.
     * @param layers     the collection of layers used for initialising the customer
     *                   deck.
    ...
    /**
     * Adds a customer order from the top of the customerDeck, after a space is
     * created by the timePasses method.
     * Returns the customer who left, if applicable, null, otherwise.
     *
     * @return The customer if they left the bakery after this round, null,
     *         otherwise.
     */
     ...
     *
     * @return A collection of customer orders indicating the customers in the
     *         bakery.
     */
    ...
    /**
     * Gets the customer orders fulfillable only with the ingredients contained the
     * parameter hand.
     *
     * @param hand The list of ingredients to check against the recipe of the
     *             customer orders.
     * @return A collection of customer orders which can be fulfilled by the
     *         ingredients in the hand.
     */
    ...
    /**
     * Returns the customer orders with the particular CustomerOrderStatus given by
     * parameter status.
     *
    ...
    /**
     * Initialises the customerDeck pile from the deckFile file, according to the
     ...
     *
     * @return True, if there are one or more customers in the bakery, false,
     *         otherwise.
     */
    ...
    /**
     * Returns the customer at the rightmost space of the shop or null, if there is
     * no one in that spot.
     *
    ...
    public void remove(CustomerOrder customer) {
        ((LinkedList<CustomerOrder>) this.activeCustomers)
                .set(((LinkedList<CustomerOrder>) this.activeCustomers).indexOf(customer), null);
    ...
    public CustomerOrder timePasses() {
        ...
        if (customerWillLeaveSoon()) {
            CustomerOrder leaving = ((LinkedList<CustomerOrder>) this.activeCustomers).remove(); // Removes the customer
                                                                                                 // about to leave soon
            this.activeCustomers.add(null);
            leaving.abandon();
