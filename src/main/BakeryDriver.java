...
public class BakeryDriver {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* SET UP */
        // Create an instance of the Magic Bakery
        MagicBakery ob = new MagicBakery(27, IODIR + "ingredients.csv", IODIR + "layers.csv");

        // Create an instance of the Console Utilities
        ConsoleUtils in = new ConsoleUtils();

        // Prompt for players and their names
        ...
        for (int i = 0; i < ROUNDS; i++) {
            ...
            switch (action) {
                ...
                case PASS_INGREDIENT:
                    ...
                    ingredient = in.promptForIngredient("Enter the ingredient to pass to the other user: ",
